...
function News() {
  const newsData = [
    ...
    },
    {
      ...
      description:
        "For the second time, the General Superintendent of Assemblies of God...",
    },
    {
      ...
      description:
        "Accra, Nov 30, GNA – Apostle Dr Samuel Vincent Ansah, Chair, Ghana National Council, Great Commission Church International (GCCI) has urged Churches to develop structures for making Christ-like disciples....",
    },
  ];
